...
; Folding a splat inline constant must preserve the destination op_sel (the
; intrinsic word_sel): word_sel=0 writes the packed result to the LOW half,
; word_sel=1 to the HIGH half -- like the register forms
; test_cvt_scalef32_pk_fp8_bf16_imm1 (word_sel=0) and _imm0 (word_sel=1) above.
define <2 x i16> @test_cvt_scalef32_pk_fp8_bf16_imm_word0(<2 x i16> %old, float %scale) {
; GCN-LABEL: test_cvt_scalef32_pk_fp8_bf16_imm_word0:
; GCN:       ; %bb.0:
; GCN-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GCN-NEXT:    v_cvt_scalef32_pk_fp8_bf16 v0, 4.0, v1
; GCN-NEXT:    s_setpc_b64 s[30:31]
...
define <2 x i16> @test_cvt_scalef32_pk_fp8_bf16_imm_word1(<2 x i16> %old, float %scale) {
...
define <2 x i16> @test_cvt_scalef32_pk_fp8_f16_imm_word0(<2 x i16> %old, float %scale) {
; GCN-LABEL: test_cvt_scalef32_pk_fp8_f16_imm_word0:
; GCN:       ; %bb.0:
; GCN-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GCN-NEXT:    v_cvt_scalef32_pk_fp8_f16 v0, 4.0, v1
; GCN-NEXT:    s_setpc_b64 s[30:31]
...
define <2 x i16> @test_cvt_scalef32_pk_fp8_f16_imm_word1(<2 x i16> %old, float %scale) {
