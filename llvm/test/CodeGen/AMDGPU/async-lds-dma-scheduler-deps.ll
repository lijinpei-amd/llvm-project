...
; CHECK-LABEL: SU(6): BUFFER_LOAD_DWORD_LDS_OFFSET_ASYNC{{.*}}implicit $gfx9_asynccnt
...
; CHECK-NEXT:     SU(8): Data Latency=1 Reg=$gfx9_asynccnt
; CHECK-NEXT:     Pressure Diff
; CHECK-LABEL: SU(8): BUFFER_LOAD_DWORD_LDS_OFFSET_ASYNC{{.*}}implicit $gfx9_asynccnt
...
;
; CHECK-LABEL: SU(7): BUFFER_LOAD_DWORD_LDS_OFFSET_ASYNC{{.*}}implicit $gfx9_asynccnt
; CHECK-LABEL:   Predecessors:
; CHECK-LABEL:   Successors:
; CHECK:          SU(8): Anti Latency=0
; CHECK-LABEL: Pressure Diff
...
; CHECK-LABEL:   Successors:
; CHECK:          SU(10): Data Latency=1 Reg=$gfx9_asynccnt
; CHECK:          SU(9): Data Latency=1 Reg=$gfx9_asynccnt
; CHECK:          SU(10): Data Latency=0 Reg=$asynccnt
...
; CHECK-LABEL: Pressure Diff
;
; CHECK-LABEL: SU(9): BUFFER_LOAD_DWORD_LDS_OFFSET_ASYNC{{.*}}implicit $gfx9_asynccnt
; CHECK-LABEL:   Predecessors:
; CHECK:          SU(8): Data Latency=1 Reg=$gfx9_asynccnt
; CHECK-LABEL:   Successors:
; CHECK:          SU(11): Anti Latency=0
; CHECK:          SU(10): Anti Latency=0
; CHECK-LABEL: Pressure Diff
...
; CHECK:          SU(8): Data Latency=1 Reg=$gfx9_asynccnt
; CHECK:          SU(8): Data Latency=0 Reg=$asynccnt
; CHECK:          SU(8): Anti Latency=0
; CHECK:          SU(8): Anti Latency=0
; CHECK:          SU(7): Anti Latency=0
; CHECK:          SU(6): Anti Latency=0
; CHECK-NOT:      SU(9): Ord  Latency=0 Barrier
; CHECK-LABEL:   Successors:
; CHECK:          SU(11): Data Latency=1 Reg=$gfx9_asynccnt
; CHECK:          SU(11): Data Latency=0 Reg=$asynccnt
; CHECK:          SU(11): Anti Latency=0
; CHECK:          SU(11): Anti Latency=0
...
; CHECK-NOT:      Reg=$gfx9_asynccnt
; CHECK-NOT:      Reg=$asynccnt
; CHECK-LABEL: Pressure Diff
;
; CHECK-LABEL: SU(12): BUFFER_LOAD_DWORD_LDS_OFFSET_ASYNC{{.*}}implicit $gfx9_asynccnt
; CHECK-LABEL:   Predecessors:
; CHECK-LABEL:   Successors:
...
; CHECK-LABEL: Pressure Diff
;
; CHECK-LABEL: SU(16): BUFFER_LOAD_DWORD_LDS_OFFSET_ASYNC{{.*}}implicit $gfx9_asynccnt
; CHECK-LABEL:   Predecessors:
; CHECK:          SU(13): Data Latency=1 Reg=$gfx9_asynccnt
; CHECK-LABEL:   Successors:
; CHECK:          SU(17): Anti Latency=0
; CHECK:          SU(17): Ord  Latency=0 Barrier
; CHECK-NOT:      Reg=$asynccnt
...
; CHECK:          SU(13): Data Latency=1 Reg=$gfx9_asynccnt
; CHECK:          SU(13): Data Latency=0 Reg=$asynccnt
; CHECK:          SU(13): Anti Latency=0
; CHECK:          SU(13): Anti Latency=0
; CHECK:          SU(12): Anti Latency=0
