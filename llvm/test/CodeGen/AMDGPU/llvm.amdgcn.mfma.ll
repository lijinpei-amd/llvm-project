...
; GFX942-NEXT:    v_mov_b32_e32 v34, 1.0
...
; GFX942-NEXT:    s_nop 1
; GFX942-NEXT:    v_mfma_f32_32x32x1_2b_f32 v[0:31], v34, v33, v[0:31] cbsz:1 abid:2 blgp:3
...
; GFX942-VGPR-NEXT:    v_mov_b32_e32 v34, 1.0
...
; GFX942-VGPR-NEXT:    v_mfma_f32_32x32x1_2b_f32 v[0:31], v34, v33, v[0:31] cbsz:1 abid:2 blgp:3
...
; GFX942-NEXT:    v_mov_b32_e32 v16, 2.0
; GFX942-NEXT:    v_mov_b32_e32 v17, 1.0
; GFX942-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX942-NEXT:    s_nop 1
; GFX942-NEXT:    v_mfma_f32_16x16x1_4b_f32 v[0:15], v17, v16, v[0:15] cbsz:1 abid:2 blgp:3
...
; GFX942-VGPR-NEXT:    v_mov_b32_e32 v16, 2.0
; GFX942-VGPR-NEXT:    v_mov_b32_e32 v17, 1.0
; GFX942-VGPR-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX942-VGPR-NEXT:    s_nop 1
; GFX942-VGPR-NEXT:    v_mfma_f32_16x16x1_4b_f32 v[0:15], v17, v16, v[0:15] cbsz:1 abid:2 blgp:3
...
; GFX942-NEXT:    v_mov_b32_e32 v6, 1.0
...
; GFX942-NEXT:    v_mov_b64_e32 v[2:3], s[2:3]
; GFX942-NEXT:    s_nop 1
; GFX942-NEXT:    v_mfma_f32_4x4x1_16b_f32 v[0:3], v6, v5, v[0:3] cbsz:1 abid:2 blgp:3
; GFX942-NEXT:    s_nop 3
...
; GFX942-VGPR-NEXT:    v_mov_b32_e32 v6, 1.0
...
; GFX942-VGPR-NEXT:    v_mov_b64_e32 v[2:3], s[2:3]
; GFX942-VGPR-NEXT:    s_nop 1
; GFX942-VGPR-NEXT:    v_mfma_f32_4x4x1_16b_f32 v[0:3], v6, v5, v[0:3] cbsz:1 abid:2 blgp:3
...
; GFX942-NEXT:    v_mov_b64_e32 v[14:15], s[14:15]
; GFX942-NEXT:    s_nop 1
; GFX942-NEXT:    v_mfma_f32_32x32x2_f32 v[0:15], v17, v16, v[0:15] cbsz:1 abid:2 blgp:3
; GFX942-NEXT:    v_mov_b32_e32 v16, 0
; GFX942-NEXT:    s_nop 15
; GFX942-NEXT:    s_nop 0
; GFX942-NEXT:    global_store_dwordx4 v16, v[12:15], s[16:17] offset:48
...
; GFX942-VGPR-NEXT:    v_mov_b64_e32 v[14:15], s[14:15]
; GFX942-VGPR-NEXT:    s_nop 1
; GFX942-VGPR-NEXT:    v_mfma_f32_32x32x2_f32 v[0:15], v17, v16, v[0:15] cbsz:1 abid:2 blgp:3
; GFX942-VGPR-NEXT:    v_mov_b32_e32 v16, 0
; GFX942-VGPR-NEXT:    s_nop 15
...
; GFX942-NEXT:    v_mov_b64_e32 v[2:3], s[2:3]
; GFX942-NEXT:    s_nop 1
; GFX942-NEXT:    v_mfma_f32_16x16x4_f32 v[0:3], v6, v5, v[0:3] cbsz:1 abid:2 blgp:3
; GFX942-NEXT:    s_nop 9
; GFX942-NEXT:    global_store_dwordx4 v4, v[0:3], s[6:7]
; GFX942-NEXT:    s_endpgm
;
...
; GFX942-VGPR-NEXT:    v_mov_b64_e32 v[2:3], s[2:3]
; GFX942-VGPR-NEXT:    s_nop 1
; GFX942-VGPR-NEXT:    v_mfma_f32_16x16x4_f32 v[0:3], v6, v5, v[0:3] cbsz:1 abid:2 blgp:3
...
; GFX942:       ; %bb.0: ; %bb
; GFX942-NEXT:    s_load_dwordx2 s[34:35], s[4:5], 0x24
; GFX942-NEXT:    v_mov_b32_e32 v33, 2
...
; GFX942-NEXT:    v_mov_b32_e32 v31, s15
; GFX942-NEXT:    s_nop 1
; GFX942-NEXT:    v_mfma_i32_32x32x4_2b_i8 v[0:31], v34, v33, v[0:31] cbsz:1 abid:2 blgp:3
; GFX942-NEXT:    s_nop 15
; GFX942-NEXT:    s_nop 2
; GFX942-NEXT:    global_store_dwordx4 v32, v[24:27], s[34:35] offset:96
; GFX942-NEXT:    global_store_dwordx4 v32, v[28:31], s[34:35] offset:112
...
; GFX942-VGPR:       ; %bb.0: ; %bb
; GFX942-VGPR-NEXT:    s_load_dwordx2 s[34:35], s[4:5], 0x24
; GFX942-VGPR-NEXT:    v_mov_b32_e32 v33, 2
...
; GFX942-VGPR-NEXT:    v_mov_b32_e32 v31, s15
; GFX942-VGPR-NEXT:    s_nop 1
; GFX942-VGPR-NEXT:    v_mfma_i32_32x32x4_2b_i8 v[0:31], v34, v33, v[0:31] cbsz:1 abid:2 blgp:3
; GFX942-VGPR-NEXT:    s_nop 15
; GFX942-VGPR-NEXT:    s_nop 2
; GFX942-VGPR-NEXT:    global_store_dwordx4 v32, v[24:27], s[34:35] offset:96
; GFX942-VGPR-NEXT:    global_store_dwordx4 v32, v[28:31], s[34:35] offset:112
...
; GFX942-NEXT:    v_mov_b32_e32 v17, 1
; GFX942-NEXT:    s_waitcnt lgkmcnt(0)
; GFX942-NEXT:    s_load_dwordx16 s[0:15], s[16:17], 0x0
; GFX942-NEXT:    s_waitcnt lgkmcnt(0)
; GFX942-NEXT:    v_mov_b64_e32 v[0:1], s[0:1]
...
; GFX942-NEXT:    v_mov_b64_e32 v[14:15], s[14:15]
; GFX942-NEXT:    s_nop 1
; GFX942-NEXT:    v_mfma_i32_16x16x4_4b_i8 v[0:15], v17, v16, v[0:15] cbsz:1 abid:2 blgp:3
; GFX942-NEXT:    v_mov_b32_e32 v16, 0
; GFX942-NEXT:    s_nop 9
; GFX942-NEXT:    global_store_dwordx4 v16, v[12:15], s[16:17] offset:48
; GFX942-NEXT:    global_store_dwordx4 v16, v[8:11], s[16:17] offset:32
...
; GFX942-VGPR-NEXT:    v_mov_b64_e32 v[14:15], s[14:15]
; GFX942-VGPR-NEXT:    s_nop 1
; GFX942-VGPR-NEXT:    v_mfma_i32_16x16x4_4b_i8 v[0:15], v17, v16, v[0:15] cbsz:1 abid:2 blgp:3
; GFX942-VGPR-NEXT:    v_mov_b32_e32 v16, 0
; GFX942-VGPR-NEXT:    s_nop 9
; GFX942-VGPR-NEXT:    global_store_dwordx4 v16, v[12:15], s[16:17] offset:48
; GFX942-VGPR-NEXT:    global_store_dwordx4 v16, v[8:11], s[16:17] offset:32
...
; GFX90A-NEXT:    s_nop 0
; GFX90A-NEXT:    v_mfma_i32_16x16x4i8 v[0:15], v16, v17, 64 cbsz:1 abid:2 blgp:3
; GFX90A-NEXT:    v_mov_b32_e32 v16, 0
; GFX90A-NEXT:    s_waitcnt lgkmcnt(0)
; GFX90A-NEXT:    s_nop 8
...
; GFX942-NEXT:    s_nop 0
; GFX942-NEXT:    v_mfma_i32_16x16x4_4b_i8 v[0:15], v17, v16, 64 cbsz:1 abid:2 blgp:3
; GFX942-NEXT:    v_mov_b32_e32 v16, 0
; GFX942-NEXT:    s_waitcnt lgkmcnt(0)
; GFX942-NEXT:    s_nop 8
...
; GFX942-VGPR-NEXT:    s_nop 0
; GFX942-VGPR-NEXT:    v_mfma_i32_16x16x4_4b_i8 v[0:15], v17, v16, 64 cbsz:1 abid:2 blgp:3
; GFX942-VGPR-NEXT:    v_mov_b32_e32 v16, 0
; GFX942-VGPR-NEXT:    s_waitcnt lgkmcnt(0)
; GFX942-VGPR-NEXT:    s_nop 8
...
; GFX942:       ; %bb.0: ; %bb
; GFX942-NEXT:    s_load_dwordx2 s[6:7], s[4:5], 0x24
; GFX942-NEXT:    v_mov_b32_e32 v5, 2
...
; GFX942-NEXT:    v_mov_b64_e32 v[2:3], s[2:3]
; GFX942-NEXT:    s_nop 1
; GFX942-NEXT:    v_mfma_i32_4x4x4_16b_i8 v[0:3], v6, v5, v[0:3] cbsz:1 abid:2 blgp:3
; GFX942-NEXT:    s_nop 4
; GFX942-NEXT:    global_store_dwordx4 v4, v[0:3], s[6:7]
; GFX942-NEXT:    s_endpgm
;
...
; GFX942-VGPR-NEXT:    v_mov_b64_e32 v[2:3], s[2:3]
; GFX942-VGPR-NEXT:    s_nop 1
; GFX942-VGPR-NEXT:    v_mfma_i32_4x4x4_16b_i8 v[0:3], v6, v5, v[0:3] cbsz:1 abid:2 blgp:3
; GFX942-VGPR-NEXT:    s_nop 4
; GFX942-VGPR-NEXT:    global_store_dwordx4 v4, v[0:3], s[6:7]
; GFX942-VGPR-NEXT:    s_endpgm
bb:
...
; GFX942-VGPR:       ; %bb.0: ; %bb
; GFX942-VGPR-NEXT:    s_load_dwordx2 s[34:35], s[4:5], 0x24
; GFX942-VGPR-NEXT:    v_mov_b32_e32 v32, 2.0
...
; GFX942-VGPR-NEXT:    v_mov_b32_e32 v31, s15
; GFX942-VGPR-NEXT:    s_nop 1
; GFX942-VGPR-NEXT:    v_mfma_f32_32x32x1_2b_f32 v[0:31], v33, v32, v[0:31]
; GFX942-VGPR-NEXT:    v_mfma_f32_32x32x1_2b_f32 v[0:31], v33, v32, v[0:31]
; GFX942-VGPR-NEXT:    v_mov_b32_e32 v32, 0
; GFX942-VGPR-NEXT:    s_nop 15
; GFX942-VGPR-NEXT:    s_nop 0
...
; GFX942-NEXT:    v_mov_b64_e32 v[14:15], s[14:15]
; GFX942-NEXT:    s_nop 1
; GFX942-NEXT:    v_mfma_f32_16x16x1_4b_f32 v[0:15], v17, v16, v[0:15]
; GFX942-NEXT:    v_mfma_f32_16x16x1_4b_f32 v[0:15], v17, v16, v[0:15]
; GFX942-NEXT:    v_mov_b32_e32 v16, 0
; GFX942-NEXT:    s_nop 8
; GFX942-NEXT:    global_store_dwordx4 v16, v[12:15], s[16:17] offset:48
...
; GFX942-VGPR-NEXT:    v_mov_b64_e32 v[14:15], s[14:15]
; GFX942-VGPR-NEXT:    s_nop 1
; GFX942-VGPR-NEXT:    v_mfma_f32_16x16x1_4b_f32 v[0:15], v17, v16, v[0:15]
; GFX942-VGPR-NEXT:    v_mfma_f32_16x16x1_4b_f32 v[0:15], v17, v16, v[0:15]
; GFX942-VGPR-NEXT:    v_mov_b32_e32 v16, 0
; GFX942-VGPR-NEXT:    s_nop 8
; GFX942-VGPR-NEXT:    global_store_dwordx4 v16, v[12:15], s[16:17] offset:48
...
; GFX942:       ; %bb.0: ; %bb
; GFX942-NEXT:    s_load_dwordx2 s[6:7], s[4:5], 0x24
; GFX942-NEXT:    v_mov_b32_e32 v4, 2.0
...
; GFX942-NEXT:    v_mov_b64_e32 v[2:3], s[2:3]
; GFX942-NEXT:    s_nop 1
; GFX942-NEXT:    v_mfma_f32_4x4x1_16b_f32 v[0:3], v5, v4, v[0:3]
; GFX942-NEXT:    s_nop 1
; GFX942-NEXT:    v_mfma_f32_4x4x1_16b_f32 v[0:3], v5, v4, v[0:3]
; GFX942-NEXT:    s_nop 3
...
; GFX942-VGPR:       ; %bb.0: ; %bb
; GFX942-VGPR-NEXT:    s_load_dwordx2 s[6:7], s[4:5], 0x24
; GFX942-VGPR-NEXT:    v_mov_b32_e32 v4, 2.0
...
; GFX942-VGPR-NEXT:    v_mov_b64_e32 v[2:3], s[2:3]
; GFX942-VGPR-NEXT:    s_nop 1
; GFX942-VGPR-NEXT:    v_mfma_f32_4x4x1_16b_f32 v[0:3], v5, v4, v[0:3]
; GFX942-VGPR-NEXT:    s_nop 1
; GFX942-VGPR-NEXT:    v_mfma_f32_4x4x1_16b_f32 v[0:3], v5, v4, v[0:3]
; GFX942-VGPR-NEXT:    s_nop 3
...
; GFX90A-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x24
; GFX90A-NEXT:    s_nop 0
; GFX90A-NEXT:    v_mfma_f32_16x16x1f32 v[0:15], v16, v17, 1.0
; GFX90A-NEXT:    v_mov_b32_e32 v16, 0
; GFX90A-NEXT:    s_waitcnt lgkmcnt(0)
; GFX90A-NEXT:    s_nop 8
; GFX90A-NEXT:    global_store_dwordx4 v16, v[12:15], s[0:1] offset:48
...
; GFX90A-NEXT:    v_mov_b32_e32 v17, v16
; GFX90A-NEXT:    v_mov_b32_e32 v18, 0x40004000
; GFX90A-NEXT:    v_mov_b32_e32 v19, v18
; GFX90A-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x24
; GFX90A-NEXT:    s_nop 0
; GFX90A-NEXT:    v_mfma_f32_32x32x8f16 v[0:15], v[16:17], v[18:19], 1.0
; GFX90A-NEXT:    v_mov_b32_e32 v16, 0
; GFX90A-NEXT:    s_waitcnt lgkmcnt(0)
; GFX90A-NEXT:    s_nop 15
; GFX90A-NEXT:    s_nop 0
...
; GFX942:       ; %bb.0: ; %bb
; GFX942-NEXT:    v_mov_b32_e32 v16, 0x40004000
; GFX942-NEXT:    v_mov_b32_e32 v18, 0x3c003c00
; GFX942-NEXT:    v_mov_b32_e32 v17, v16
; GFX942-NEXT:    v_mov_b32_e32 v19, v18
; GFX942-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x24
; GFX942-NEXT:    s_nop 0
; GFX942-NEXT:    v_mfma_f32_32x32x8_f16 v[0:15], v[18:19], v[16:17], 1.0
; GFX942-NEXT:    v_mov_b32_e32 v16, 0
; GFX942-NEXT:    s_waitcnt lgkmcnt(0)
; GFX942-NEXT:    s_nop 8
; GFX942-NEXT:    global_store_dwordx4 v16, v[12:15], s[0:1] offset:48
...
; GFX942-VGPR:       ; %bb.0: ; %bb
; GFX942-VGPR-NEXT:    v_mov_b32_e32 v16, 0x40004000
; GFX942-VGPR-NEXT:    v_mov_b32_e32 v18, 0x3c003c00
; GFX942-VGPR-NEXT:    v_mov_b32_e32 v17, v16
; GFX942-VGPR-NEXT:    v_mov_b32_e32 v19, v18
; GFX942-VGPR-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x24
; GFX942-VGPR-NEXT:    s_nop 0
; GFX942-VGPR-NEXT:    v_mfma_f32_32x32x8_f16 v[0:15], v[18:19], v[16:17], 1.0
; GFX942-VGPR-NEXT:    v_mov_b32_e32 v16, 0
; GFX942-VGPR-NEXT:    s_waitcnt lgkmcnt(0)
; GFX942-VGPR-NEXT:    s_nop 8
; GFX942-VGPR-NEXT:    global_store_dwordx4 v16, v[12:15], s[0:1] offset:48
...
; GFX942-VGPR-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x24
; GFX942-VGPR-NEXT:    s_nop 0
; GFX942-VGPR-NEXT:    v_mfma_f32_32x32x1_2b_f32 v[0:31], v33, v32, 0
; GFX942-VGPR-NEXT:    v_mov_b32_e32 v32, 0
; GFX942-VGPR-NEXT:    s_waitcnt lgkmcnt(0)
; GFX942-VGPR-NEXT:    s_nop 15
...
; GFX942-NEXT:    v_mov_b32_e32 v6, 1.0
; GFX942-NEXT:    s_nop 1
; GFX942-NEXT:    v_mfma_f32_4x4x1_16b_f32 v[0:3], v6, v5, v[0:3]
; GFX942-NEXT:    s_waitcnt lgkmcnt(0)
; GFX942-NEXT:    s_nop 2
; GFX942-NEXT:    global_store_dwordx4 v4, v[0:3], s[0:1]
; GFX942-NEXT:    s_endpgm
...
; GFX942-VGPR-NEXT:    v_mov_b32_e32 v6, 1.0
; GFX942-VGPR-NEXT:    s_nop 1
; GFX942-VGPR-NEXT:    v_mfma_f32_4x4x1_16b_f32 v[0:3], v6, v5, v[0:3]
; GFX942-VGPR-NEXT:    s_waitcnt lgkmcnt(0)
; GFX942-VGPR-NEXT:    s_nop 2
; GFX942-VGPR-NEXT:    global_store_dwordx4 v4, v[0:3], s[0:1]
; GFX942-VGPR-NEXT:    s_endpgm
