...
; GFX90A-NEXT:    s_nop 1
; GFX90A-NEXT:    v_mfma_f64_4x4x4f64 v[0:1], v[2:3], v[4:5], 0
; GFX90A-NEXT:    s_nop 3
; GFX90A-NEXT:    v_mfma_f64_4x4x4f64 v[0:1], v[2:3], v[4:5], v[0:1] cbsz:1 abid:2 blgp:3
...
; GFX942-NEXT:    s_nop 1
; GFX942-NEXT:    v_mfma_f64_4x4x4_4b_f64 v[0:1], v[2:3], v[4:5], 0
; GFX942-NEXT:    s_nop 3
; GFX942-NEXT:    v_mfma_f64_4x4x4_4b_f64 v[0:1], v[2:3], v[4:5], v[0:1] cbsz:1 abid:2 neg:[1,1,0]
...
; GFX90A-NEXT:    s_waitcnt lgkmcnt(0)
; GFX90A-NEXT:    v_mov_b32_e32 v8, s10
; GFX90A-NEXT:    s_load_dwordx8 s[0:7], s[8:9], 0x0
; GFX90A-NEXT:    v_mov_b32_e32 v9, s11
...
; GFX90A-NEXT:    v_mov_b32_e32 v2, v0
; GFX90A-NEXT:    s_waitcnt lgkmcnt(0)
; GFX90A-NEXT:    v_mov_b32_e32 v10, s2
; GFX90A-NEXT:    v_mov_b32_e32 v11, s3
; GFX90A-NEXT:    v_mov_b32_e32 v3, v0
; GFX90A-NEXT:    v_mov_b32_e32 v4, v0
; GFX90A-NEXT:    v_mov_b32_e32 v5, v0
; GFX90A-NEXT:    v_mov_b32_e32 v6, v0
