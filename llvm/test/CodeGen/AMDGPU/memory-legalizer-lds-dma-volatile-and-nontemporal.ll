...
; RUN: llc -mtriple=amdgpu9.0a-- -global-isel=0 < %s | FileCheck --check-prefixes=GFX90A %s
; RUN: llc -mtriple=amdgpu9.42-- -global-isel=0 < %s | FileCheck --check-prefixes=GFX942 %s
; RUN: llc -mtriple=amdgpu9.42-- -global-isel=1 < %s | FileCheck --check-prefixes=GFX942-GISEL %s
; RUN: llc -mtriple=amdgpu10.10-- -global-isel=0 < %s | FileCheck --check-prefixes=GFX10 %s
