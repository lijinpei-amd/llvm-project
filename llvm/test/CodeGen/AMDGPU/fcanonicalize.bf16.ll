...
; FAKE16-NEXT:    v_pk_mul_bf16 v0, 1.0, v0 op_sel:[1,0]
...
; REAL16-NEXT:    v_pk_mul_bf16 v0, 1.0, v0 op_sel:[1,0]
...
; GFX1250-NEXT:    s_wait_loadcnt 0x0
; GFX1250-NEXT:    v_pk_mul_bf16 v0, 1.0, v0 op_sel:[1,0]
...
; GFX1250-NEXT:    v_and_b32_e32 v0, 0x7fff7fff, v0
; GFX1250-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1250-NEXT:    v_pk_mul_bf16 v0, 1.0, v0 op_sel:[1,0] neg_lo:[0,1] neg_hi:[0,1]
; GFX1250-NEXT:    global_store_b32 v1, v0, s[0:1]
; GFX1250-NEXT:    s_endpgm
  %tid = call i32 @llvm.amdgcn.workitem.id.x()
  %gep = getelementptr <2 x bfloat>, ptr addrspace(1) %out, i32 %tid
...
; GFX1250-NEXT:    v_mov_b32_e32 v0, 0
; GFX1250-NEXT:    s_wait_kmcnt 0x0
; GFX1250-NEXT:    v_pk_mul_bf16 v1, 1.0, s2 op_sel:[1,0]
...
; GFX1250-NEXT:    s_wait_kmcnt 0x0
; GFX1250-NEXT:    v_pk_mul_bf16 v0, 1.0, v0 op_sel:[1,0]
; GFX1250-NEXT:    v_pk_mul_bf16 v1, 1.0, v1 op_sel:[1,0]
...
; REAL16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; REAL16-NEXT:    v_pk_mul_bf16 v0, 1.0, v1 op_sel:[1,0]
; REAL16-NEXT:    s_set_pc_i64 s[30:31]
...
; FAKE16-NEXT:    v_pk_mul_bf16 v0, 1.0, v0 op_sel:[1,0]
; FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_2)
; FAKE16-NEXT:    v_pk_mul_bf16 v1, 1.0, v1 op_sel:[1,0]
; FAKE16-NEXT:    s_set_pc_i64 s[30:31]
;
...
; REAL16-NEXT:    v_pk_mul_bf16 v0, 1.0, v0 op_sel:[1,0]
; REAL16-NEXT:    s_delay_alu instid0(VALU_DEP_2)
; REAL16-NEXT:    v_pk_mul_bf16 v1, 1.0, v1 op_sel:[1,0]
; REAL16-NEXT:    s_set_pc_i64 s[30:31]
  %vec0 = insertelement <4 x bfloat> poison, bfloat %val0, i32 0
...
; GFX1250-NEXT:    v_pk_mul_bf16 v0, 1.0, v0 op_sel:[1,0]
; GFX1250-NEXT:    v_pk_mul_bf16 v1, 1.0, v1 op_sel:[1,0]
; GFX1250-NEXT:    v_pk_mul_bf16 v2, 1.0, v2 op_sel:[1,0]
; GFX1250-NEXT:    s_set_pc_i64 s[30:31]
...
; GFX1250-NEXT:    v_pk_mul_bf16 v1, 1.0, v1 op_sel:[1,0]
; GFX1250-NEXT:    v_pk_mul_bf16 v2, 1.0, v2 op_sel:[1,0]
; GFX1250-NEXT:    v_pk_mul_bf16 v3, 1.0, v3 op_sel:[1,0]
; GFX1250-NEXT:    s_set_pc_i64 s[30:31]
...
; GFX1250-NEXT:    v_pk_mul_bf16 v2, 1.0, v2 op_sel:[1,0]
; GFX1250-NEXT:    v_pk_mul_bf16 v3, 1.0, v3 op_sel:[1,0]
; GFX1250-NEXT:    v_pk_mul_bf16 v4, 1.0, v4 op_sel:[1,0]
; GFX1250-NEXT:    v_pk_mul_bf16 v5, 1.0, v5 op_sel:[1,0]
; GFX1250-NEXT:    s_set_pc_i64 s[30:31]
...
; GFX1250-NEXT:    v_pk_mul_bf16 v4, 1.0, v4 op_sel:[1,0]
; GFX1250-NEXT:    v_pk_mul_bf16 v5, 1.0, v5 op_sel:[1,0]
; GFX1250-NEXT:    v_pk_mul_bf16 v6, 1.0, v6 op_sel:[1,0]
; GFX1250-NEXT:    v_pk_mul_bf16 v7, 1.0, v7 op_sel:[1,0]
; GFX1250-NEXT:    s_set_pc_i64 s[30:31]
...
; GFX1250-NEXT:    v_pk_mul_bf16 v6, 1.0, v6 op_sel:[1,0]
; GFX1250-NEXT:    v_pk_mul_bf16 v7, 1.0, v7 op_sel:[1,0]
; GFX1250-NEXT:    v_pk_mul_bf16 v8, 1.0, v8 op_sel:[1,0]
; GFX1250-NEXT:    v_pk_mul_bf16 v9, 1.0, v9 op_sel:[1,0]
; GFX1250-NEXT:    v_pk_mul_bf16 v10, 1.0, v10 op_sel:[1,0]
; GFX1250-NEXT:    v_pk_mul_bf16 v11, 1.0, v11 op_sel:[1,0]
; GFX1250-NEXT:    v_pk_mul_bf16 v12, 1.0, v12 op_sel:[1,0]
; GFX1250-NEXT:    v_pk_mul_bf16 v13, 1.0, v13 op_sel:[1,0]
; GFX1250-NEXT:    v_pk_mul_bf16 v14, 1.0, v14 op_sel:[1,0]
; GFX1250-NEXT:    v_pk_mul_bf16 v15, 1.0, v15 op_sel:[1,0]
; GFX1250-NEXT:    s_set_pc_i64 s[30:31]
...
; GFX1250-NEXT:    v_pk_mul_bf16 v14, 1.0, v14 op_sel:[1,0]
; GFX1250-NEXT:    v_pk_mul_bf16 v15, 1.0, v15 op_sel:[1,0]
; GFX1250-NEXT:    v_pk_mul_bf16 v16, 1.0, v16 op_sel:[1,0]
; GFX1250-NEXT:    v_pk_mul_bf16 v17, 1.0, v17 op_sel:[1,0]
; GFX1250-NEXT:    v_pk_mul_bf16 v18, 1.0, v18 op_sel:[1,0]
; GFX1250-NEXT:    v_pk_mul_bf16 v19, 1.0, v19 op_sel:[1,0]
; GFX1250-NEXT:    v_pk_mul_bf16 v20, 1.0, v20 op_sel:[1,0]
; GFX1250-NEXT:    v_pk_mul_bf16 v21, 1.0, v21 op_sel:[1,0]
; GFX1250-NEXT:    v_pk_mul_bf16 v22, 1.0, v22 op_sel:[1,0]
; GFX1250-NEXT:    v_pk_mul_bf16 v23, 1.0, v23 op_sel:[1,0]
; GFX1250-NEXT:    v_pk_mul_bf16 v24, 1.0, v24 op_sel:[1,0]
; GFX1250-NEXT:    v_pk_mul_bf16 v25, 1.0, v25 op_sel:[1,0]
; GFX1250-NEXT:    v_pk_mul_bf16 v26, 1.0, v26 op_sel:[1,0]
; GFX1250-NEXT:    v_pk_mul_bf16 v27, 1.0, v27 op_sel:[1,0]
; GFX1250-NEXT:    v_pk_mul_bf16 v28, 1.0, v28 op_sel:[1,0]
; GFX1250-NEXT:    v_pk_mul_bf16 v29, 1.0, v29 op_sel:[1,0]
; GFX1250-NEXT:    v_pk_mul_bf16 v30, 1.0, v30 op_sel:[1,0]
; GFX1250-NEXT:    s_wait_loadcnt 0x0
; GFX1250-NEXT:    v_pk_mul_bf16 v31, 1.0, v31 op_sel:[1,0]
; GFX1250-NEXT:    s_set_pc_i64 s[30:31]
