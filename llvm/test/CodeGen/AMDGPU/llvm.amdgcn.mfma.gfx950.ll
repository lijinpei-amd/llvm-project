...
; SDAG-NEXT:    s_nop 1
; SDAG-NEXT:    v_mfma_f32_32x32x16_f16 v[16:31], v[38:41], v[42:45], v[0:15]
; SDAG-NEXT:    s_nop 11
...
; SDAG-NEXT:    s_waitcnt vmcnt(0)
; SDAG-NEXT:    v_mov_b64_e32 v[0:1], 0
; SDAG-NEXT:    v_mov_b32_e32 v2, s16
; SDAG-NEXT:    v_mov_b32_e32 v3, s17
; SDAG-NEXT:    v_mov_b32_e32 v4, s18
; SDAG-NEXT:    v_mov_b32_e32 v5, s19
; SDAG-NEXT:    global_store_dwordx4 v[0:1], v[16:19], off sc0 sc1
; SDAG-NEXT:    s_waitcnt vmcnt(0)
; SDAG-NEXT:    global_store_dwordx4 v[34:35], v[2:5], off sc0 sc1
; SDAG-NEXT:    s_waitcnt vmcnt(0)
; SDAG-NEXT:    s_nop 0
...
; SDAG-NEXT:    global_store_dwordx4 v[32:33], v[2:5], off sc0 sc1
; SDAG-NEXT:    s_waitcnt vmcnt(0)
; SDAG-NEXT:    s_nop 0
...
; GISEL-NEXT:    v_mov_b64_e32 v[42:43], 16
; GISEL-NEXT:    v_mov_b64_e32 v[44:45], 32
; GISEL-NEXT:    s_waitcnt lgkmcnt(0)
...
; GISEL-NEXT:    global_store_dwordx4 v[42:43], v[20:23], off sc0 sc1
; GISEL-NEXT:    s_waitcnt vmcnt(0)
; GISEL-NEXT:    global_store_dwordx4 v[44:45], v[24:27], off sc0 sc1
; GISEL-NEXT:    s_waitcnt vmcnt(0)
; GISEL-NEXT:    v_mov_b64_e32 v[0:1], s[8:9]
; GISEL-NEXT:    v_mov_b64_e32 v[4:5], 48
; GISEL-NEXT:    v_mov_b64_e32 v[2:3], s[10:11]
; GISEL-NEXT:    global_store_dwordx4 v[4:5], v[28:31], off sc0 sc1
; GISEL-NEXT:    s_waitcnt vmcnt(0)
...
; GISEL-NEXT:    global_store_dwordx4 v[42:43], v[0:3], off sc0 sc1
; GISEL-NEXT:    s_waitcnt vmcnt(0)
; GISEL-NEXT:    s_nop 0
; GISEL-NEXT:    v_mov_b64_e32 v[0:1], s[16:17]
; GISEL-NEXT:    v_mov_b64_e32 v[2:3], s[18:19]
; GISEL-NEXT:    global_store_dwordx4 v[44:45], v[0:3], off sc0 sc1
; GISEL-NEXT:    s_waitcnt vmcnt(0)
; GISEL-NEXT:    s_nop 0
...
; HEURRC-NEXT:    s_waitcnt lgkmcnt(0)
; HEURRC-NEXT:    v_mov_b64_e32 v[6:7], s[24:25]
; HEURRC-NEXT:    v_mov_b64_e32 v[10:11], s[28:29]
; HEURRC-NEXT:    v_accvgpr_write_b32 a0, s8
; HEURRC-NEXT:    v_mov_b64_e32 v[8:9], s[26:27]
; HEURRC-NEXT:    v_mov_b64_e32 v[12:13], s[30:31]
...
; HEURRC-NEXT:    s_nop 1
; HEURRC-NEXT:    v_mfma_f32_32x32x16_f16 a[16:31], v[6:9], v[10:13], a[0:15]
...
; VGPRRC-NEXT:    s_nop 1
; VGPRRC-NEXT:    v_mfma_f32_32x32x16_f16 v[16:31], v[38:41], v[42:45], v[0:15]
...
; VGPRRC-NEXT:    s_waitcnt vmcnt(0)
; VGPRRC-NEXT:    v_mov_b64_e32 v[0:1], 0
; VGPRRC-NEXT:    v_mov_b32_e32 v2, s16
; VGPRRC-NEXT:    v_mov_b32_e32 v3, s17
; VGPRRC-NEXT:    v_mov_b32_e32 v4, s18
; VGPRRC-NEXT:    v_mov_b32_e32 v5, s19
; VGPRRC-NEXT:    global_store_dwordx4 v[0:1], v[16:19], off sc0 sc1
; VGPRRC-NEXT:    s_waitcnt vmcnt(0)
; VGPRRC-NEXT:    global_store_dwordx4 v[34:35], v[2:5], off sc0 sc1
; VGPRRC-NEXT:    s_waitcnt vmcnt(0)
; VGPRRC-NEXT:    s_nop 0
; VGPRRC-NEXT:    v_mov_b32_e32 v2, s20
; VGPRRC-NEXT:    v_mov_b32_e32 v3, s21
; VGPRRC-NEXT:    v_mov_b32_e32 v4, s22
; VGPRRC-NEXT:    v_mov_b32_e32 v5, s23
; VGPRRC-NEXT:    global_store_dwordx4 v[32:33], v[2:5], off sc0 sc1
; VGPRRC-NEXT:    s_waitcnt vmcnt(0)
; VGPRRC-NEXT:    s_nop 0
; VGPRRC-NEXT:    v_mov_b32_e32 v2, s8
; VGPRRC-NEXT:    v_mov_b32_e32 v3, s9
; VGPRRC-NEXT:    v_mov_b32_e32 v4, s10
; VGPRRC-NEXT:    v_mov_b32_e32 v5, s11
...
; SDAG-NEXT:    v_mov_b64_e32 v[14:15], s[22:23]
; SDAG-NEXT:    s_nop 1
; SDAG-NEXT:    v_mfma_f32_32x32x16_f16 v[16:31], v[38:41], v[42:45], v[0:15] cbsz:2 abid:3 blgp:1
; SDAG-NEXT:    s_nop 11
; SDAG-NEXT:    global_store_dwordx4 v[32:33], v[28:31], off sc0 sc1
; SDAG-NEXT:    s_waitcnt vmcnt(0)
; SDAG-NEXT:    global_store_dwordx4 v[34:35], v[24:27], off sc0 sc1
...
; HEURRC-NEXT:    v_accvgpr_write_b32 a15, s23
; HEURRC-NEXT:    s_nop 1
; HEURRC-NEXT:    v_mfma_f32_32x32x16_f16 a[16:31], v[6:9], v[10:13], a[0:15] cbsz:2 abid:3 blgp:1
; HEURRC-NEXT:    v_mov_b64_e32 v[6:7], 0
; HEURRC-NEXT:    v_mov_b32_e32 v8, s16
; HEURRC-NEXT:    v_mov_b32_e32 v9, s17
; HEURRC-NEXT:    v_mov_b32_e32 v10, s18
...
; VGPRRC-NEXT:    v_mov_b64_e32 v[14:15], s[22:23]
; VGPRRC-NEXT:    s_nop 1
; VGPRRC-NEXT:    v_mfma_f32_32x32x16_f16 v[16:31], v[38:41], v[42:45], v[0:15] cbsz:2 abid:3 blgp:1
; VGPRRC-NEXT:    s_nop 11
; VGPRRC-NEXT:    global_store_dwordx4 v[32:33], v[28:31], off sc0 sc1
; VGPRRC-NEXT:    s_waitcnt vmcnt(0)
; VGPRRC-NEXT:    global_store_dwordx4 v[34:35], v[24:27], off sc0 sc1
...
; GISEL-NEXT:    global_store_dwordx4 v20, v[16:19], s[0:1] sc0 sc1
; GISEL-NEXT:    s_waitcnt vmcnt(0)
; GISEL-NEXT:    s_nop 0
; GISEL-NEXT:    v_mov_b64_e32 v[18:19], s[14:15]
; GISEL-NEXT:    v_mov_b64_e32 v[16:17], s[12:13]
; GISEL-NEXT:    global_store_dwordx4 v20, v[16:19], s[0:1] offset:16 sc0 sc1
; GISEL-NEXT:    s_waitcnt vmcnt(0)
; GISEL-NEXT:    s_nop 0
; GISEL-NEXT:    v_mov_b64_e32 v[16:17], s[16:17]
; GISEL-NEXT:    v_mov_b64_e32 v[18:19], s[18:19]
; GISEL-NEXT:    global_store_dwordx4 v20, v[16:19], s[0:1] offset:32 sc0 sc1
; GISEL-NEXT:    s_waitcnt vmcnt(0)
; GISEL-NEXT:    s_nop 0
; GISEL-NEXT:    v_mov_b64_e32 v[16:17], s[20:21]
; GISEL-NEXT:    v_mov_b64_e32 v[18:19], s[22:23]
; GISEL-NEXT:    global_store_dwordx4 v20, v[16:19], s[0:1] offset:48 sc0 sc1
; GISEL-NEXT:    s_waitcnt vmcnt(0)
; GISEL-NEXT:    global_store_dwordx4 v20, v[0:3], s[0:1] sc0 sc1
; GISEL-NEXT:    s_waitcnt vmcnt(0)
; GISEL-NEXT:    global_store_dwordx4 v20, v[4:7], s[0:1] offset:16 sc0 sc1
; GISEL-NEXT:    s_waitcnt vmcnt(0)
; GISEL-NEXT:    global_store_dwordx4 v20, v[8:11], s[0:1] offset:32 sc0 sc1
; GISEL-NEXT:    s_waitcnt vmcnt(0)
; GISEL-NEXT:    global_store_dwordx4 v20, v[12:15], s[0:1] offset:48 sc0 sc1
; GISEL-NEXT:    s_waitcnt vmcnt(0)
; GISEL-NEXT:    s_endpgm
;
...
; SDAG-NEXT:    v_mov_b64_e32 v[32:33], 48
; SDAG-NEXT:    s_waitcnt lgkmcnt(0)
; SDAG-NEXT:    v_mov_b32_e32 v34, s24
; SDAG-NEXT:    v_mov_b64_e32 v[30:31], s[22:23]
; SDAG-NEXT:    v_mov_b32_e32 v35, s25
; SDAG-NEXT:    v_mov_b32_e32 v36, s26
; SDAG-NEXT:    v_mov_b32_e32 v37, s27
; SDAG-NEXT:    v_mov_b32_e32 v38, s28
; SDAG-NEXT:    v_mov_b32_e32 v39, s29
; SDAG-NEXT:    v_mov_b32_e32 v40, s30
; SDAG-NEXT:    v_mov_b32_e32 v41, s31
; SDAG-NEXT:    v_mov_b64_e32 v[28:29], s[20:21]
; SDAG-NEXT:    v_mov_b64_e32 v[26:27], s[18:19]
; SDAG-NEXT:    v_mov_b64_e32 v[24:25], s[16:17]
; SDAG-NEXT:    v_mov_b64_e32 v[22:23], s[14:15]
...
; SDAG-NEXT:    s_waitcnt vmcnt(0)
; SDAG-NEXT:    s_nop 0
; SDAG-NEXT:    v_mov_b64_e32 v[12:13], 32
; SDAG-NEXT:    global_store_dwordx4 v[12:13], v[8:11], off sc0 sc1
; SDAG-NEXT:    s_waitcnt vmcnt(0)
; SDAG-NEXT:    s_nop 0
...
; HEURRC-NEXT:    v_mov_b64_e32 v[0:1], 48
; HEURRC-NEXT:    s_waitcnt lgkmcnt(0)
; HEURRC-NEXT:    v_mov_b32_e32 v2, s24
; HEURRC-NEXT:    v_accvgpr_write_b32 a31, s23
; HEURRC-NEXT:    v_mov_b32_e32 v3, s25
; HEURRC-NEXT:    v_mov_b32_e32 v4, s26
; HEURRC-NEXT:    v_mov_b32_e32 v5, s27
; HEURRC-NEXT:    v_mov_b32_e32 v6, s28
; HEURRC-NEXT:    v_mov_b32_e32 v7, s29
; HEURRC-NEXT:    v_mov_b32_e32 v8, s30
; HEURRC-NEXT:    v_mov_b32_e32 v9, s31
...
; VGPRRC-NEXT:    v_mov_b64_e32 v[32:33], 48
; VGPRRC-NEXT:    s_waitcnt lgkmcnt(0)
; VGPRRC-NEXT:    v_mov_b32_e32 v34, s24
; VGPRRC-NEXT:    v_mov_b64_e32 v[30:31], s[22:23]
; VGPRRC-NEXT:    v_mov_b32_e32 v35, s25
; VGPRRC-NEXT:    v_mov_b32_e32 v36, s26
; VGPRRC-NEXT:    v_mov_b32_e32 v37, s27
; VGPRRC-NEXT:    v_mov_b32_e32 v38, s28
; VGPRRC-NEXT:    v_mov_b32_e32 v39, s29
; VGPRRC-NEXT:    v_mov_b32_e32 v40, s30
; VGPRRC-NEXT:    v_mov_b32_e32 v41, s31
; VGPRRC-NEXT:    v_mov_b64_e32 v[28:29], s[20:21]
; VGPRRC-NEXT:    v_mov_b64_e32 v[26:27], s[18:19]
; VGPRRC-NEXT:    v_mov_b64_e32 v[24:25], s[16:17]
; VGPRRC-NEXT:    v_mov_b64_e32 v[22:23], s[14:15]
...
; VGPRRC-NEXT:    s_waitcnt vmcnt(0)
; VGPRRC-NEXT:    s_nop 0
; VGPRRC-NEXT:    v_mov_b64_e32 v[12:13], 32
; VGPRRC-NEXT:    global_store_dwordx4 v[12:13], v[8:11], off sc0 sc1
; VGPRRC-NEXT:    s_waitcnt vmcnt(0)
; VGPRRC-NEXT:    s_nop 0
...
; VGPRRC-NEXT:    global_store_dwordx4 v[12:13], v[0:3], off sc0 sc1
; VGPRRC-NEXT:    s_waitcnt vmcnt(0)
; VGPRRC-NEXT:    s_nop 0
...
; SDAG-NEXT:    v_mov_b64_e32 v[16:17], s[8:9]
; SDAG-NEXT:    s_nop 1
; SDAG-NEXT:    v_mfma_i32_32x32x32_i8 v[0:15], v[34:37], v[38:41], v[16:31] cbsz:2 abid:3 blgp:1
; SDAG-NEXT:    s_nop 11
; SDAG-NEXT:    global_store_dwordx4 v[32:33], v[12:15], off sc0 sc1
; SDAG-NEXT:    s_waitcnt vmcnt(0)
; SDAG-NEXT:    s_nop 0
...
; HEURRC-NEXT:    v_mov_b32_e32 v10, s18
; HEURRC-NEXT:    v_mov_b32_e32 v11, s19
; HEURRC-NEXT:    v_mfma_i32_32x32x32_i8 a[0:15], v[2:5], v[6:9], a[16:31] cbsz:2 abid:3 blgp:1
; HEURRC-NEXT:    v_mov_b64_e32 v[2:3], 32
; HEURRC-NEXT:    v_mov_b64_e32 v[4:5], 16
; HEURRC-NEXT:    v_mov_b64_e32 v[6:7], 0
; HEURRC-NEXT:    v_mov_b32_e32 v8, s16
...
; VGPRRC-NEXT:    v_mov_b64_e32 v[16:17], s[8:9]
; VGPRRC-NEXT:    s_nop 1
; VGPRRC-NEXT:    v_mfma_i32_32x32x32_i8 v[0:15], v[34:37], v[38:41], v[16:31] cbsz:2 abid:3 blgp:1
; VGPRRC-NEXT:    s_nop 11
; VGPRRC-NEXT:    global_store_dwordx4 v[32:33], v[12:15], off sc0 sc1
; VGPRRC-NEXT:    s_waitcnt vmcnt(0)
; VGPRRC-NEXT:    s_nop 0
