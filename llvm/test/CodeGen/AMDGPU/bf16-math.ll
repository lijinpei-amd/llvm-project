...
; The inline constant is only in the low lane; the high lane is +0.0. The
; low lane must read the high half of the constant (op_sel:[0,1]) and the high
; lane the (zero) low half (op_sel_hi:[1,0]).
...
; The inline constant is only in the high lane; this maps to the natural
; op_sel default (low lane reads the zero low half, high lane the high half).
