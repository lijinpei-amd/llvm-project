...
; GISEL-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x80
; GISEL-NEXT:    v_mov_b64_e32 v[36:37], 0
; GISEL-NEXT:    s_waitcnt lgkmcnt(0)
...
; GISEL-NEXT:    v_mov_b32_e32 v38, s0
; GISEL-NEXT:    v_mov_b32_e32 v39, s1
; GISEL-NEXT:    v_mov_b64_e32 v[34:35], s[10:11]
; GISEL-NEXT:    v_mov_b64_e32 v[32:33], s[8:9]
; GISEL-NEXT:    v_mfma_scale_f32_32x32x64_f8f6f4 v[0:15], v[16:23], v[24:31], v[0:15], v38, v39 op_sel_hi:[0,0,0]
; GISEL-NEXT:    v_mov_b64_e32 v[18:19], s[14:15]
; GISEL-NEXT:    v_mov_b64_e32 v[16:17], s[12:13]
; GISEL-NEXT:    v_mov_b64_e32 v[20:21], 16
; GISEL-NEXT:    global_store_dwordx4 v[36:37], v[32:35], off sc0 sc1
; GISEL-NEXT:    s_waitcnt vmcnt(0)
; GISEL-NEXT:    global_store_dwordx4 v[20:21], v[16:19], off sc0 sc1
; GISEL-NEXT:    s_waitcnt vmcnt(0)
...
; GISEL-NEXT:    global_store_dwordx4 v[22:23], v[16:19], off sc0 sc1
; GISEL-NEXT:    s_waitcnt vmcnt(0)
; GISEL-NEXT:    s_nop 0
...
; GISEL-NEXT:    s_waitcnt vmcnt(0)
; GISEL-NEXT:    s_nop 1
; GISEL-NEXT:    global_store_dwordx4 v[36:37], v[0:3], off sc0 sc1
; GISEL-NEXT:    s_waitcnt vmcnt(0)
...
; GISEL-NEXT:    s_load_dwordx16 s[36:51], s[4:5], 0x0
; GISEL-NEXT:    s_load_dwordx16 s[8:23], s[4:5], 0x40
; GISEL-NEXT:    v_mov_b32_e32 v38, 25
; GISEL-NEXT:    v_mov_b32_e32 v39, 42
; GISEL-NEXT:    v_mov_b64_e32 v[36:37], 0
; GISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GISEL-NEXT:    v_mov_b64_e32 v[16:17], s[36:37]
; GISEL-NEXT:    v_mov_b64_e32 v[24:25], s[44:45]
...
; GISEL-NEXT:    v_mov_b64_e32 v[34:35], s[10:11]
; GISEL-NEXT:    v_mov_b64_e32 v[32:33], s[8:9]
; GISEL-NEXT:    v_mfma_scale_f32_32x32x64_f8f6f4 v[0:15], v[16:23], v[24:31], v[0:15], v38, v39 op_sel_hi:[0,0,0] blgp:2
; GISEL-NEXT:    v_mov_b64_e32 v[18:19], s[14:15]
; GISEL-NEXT:    v_mov_b64_e32 v[16:17], s[12:13]
; GISEL-NEXT:    v_mov_b64_e32 v[20:21], 16
; GISEL-NEXT:    global_store_dwordx4 v[36:37], v[32:35], off sc0 sc1
