...
; CHECK-NEXT:    [[TMP7:%.*]] = and <4 x i32> [[TMP2]], zeroinitializer
...
; CHECK-NEXT:    [[TMP6:%.*]] = select <4 x i1> [[TMP5]], <4 x i32> [[TMP7]], <4 x i32> <i32 2, i32 0, i32 0, i32 0>
; CHECK-NEXT:    [[TMP8:%.*]] = call i32 @llvm.vector.reduce.umax.v4i32(<4 x i32> [[TMP6]])
