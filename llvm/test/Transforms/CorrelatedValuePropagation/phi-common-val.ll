...
define ptr @simplify_phi_common_value_op0(ptr noundef %ptr, ptr %b) {
...
define ptr @simplify_phi_common_value_op1(ptr noundef %ptr, ptr %b) {
...
define i8 @simplify_phi_multiple_constants(i8 noundef %x, ptr %b) {
...
define ptr @simplify_phi_common_value_from_instruction(ptr noundef %ptr_op, ptr %b, i32 noundef %i) {
